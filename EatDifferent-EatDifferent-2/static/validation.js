const form =
  document.getElementById("form-all") || document.getElementById("login-form");

const usernameInput = document.getElementById("username");
const usernameTakenM = document.getElementById("username-taken-m");
...
const validations = {
  username: {
    ...
    cantUsername: "You can not use that username",
  },
  email: {
...
function errors() {
  ...
  if (repeatPasswordInput !== null) {
    if (usernameInput.value === "") {
      ...
      usernameInput.classList.add("input-error");
      isValid = false;
    } else if (usernameInput.value == "guest") {
      document.getElementById("username-m").innerHTML =
        validations.username.cantUsername;
      usernameInput.classList.add("input-error");
      isValid = false;
    } else {
      document.getElementById("username-m").innerHTML = "";
...
function addBlur() {
  input.forEach((input) => {
    input.addEventListener("blur", errors);
  });
}
...
form.addEventListener("submit", async (e) => {
  ...
  } else if (isFormValid && isUsernameAvailable) {
    form.submit();
  }
});
