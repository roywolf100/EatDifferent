document.addEventListener("DOMContentLoaded", function () {
  ...
  function goToNextStep(event) {
    ...
    if (isValid && currentStep < formContainers.length - 1) {
      ...
      if (formContainers[currentStep].classList.contains("animation"))
        formContainers[currentStep].classList.remove("animation");

      if (formContainers[currentStep].classList.contains("animation-back"))
        formContainers[currentStep].classList.remove("animation-back");

      currentStep++;
      formContainers[currentStep].classList.remove("none-active-form");
      if (!formContainers[currentStep].classList.contains("animation"))
        formContainers[currentStep].classList.add("animation");
    }
  }
  ...
  function goToBackStep(event) {
    ...
    if (currentStep > 0) {
      ...
      formContainers[currentStep].classList.remove("none-active-form");
      if (!formContainers[currentStep].classList.contains("animation-back"))
        formContainers[currentStep].classList.add("animation-back");
    }
  }
